                        ...
                        <div class="card-body">
                            <form action="create-user.php" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="age" name="age" main="0" max="100" required>
                                </div>
                                <div class="mb-3">
                                    <label for="Weight" class="form-label">Weight</label>
                                    <input type="number" class="form-control" id="weight" name="weight" main="0" max="100" required>
                                </div>
