                        ...
                        <div class="card-body">
                            <form action="edit-user.php?id=<?= $user['id'] ?>" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="age" name="age" main="0" max="100" value="<?= $user['age'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="Weight" class="form-label">Weight</label>
                                    <input type="number" class="form-control" id="weight" name="weight" main="0" max="100" value="<?= $user['weight'] ?>" required>
                                </div>
